...
class Ui_Main_Foram_Dialog(object):
    def setupUi(self, Main_Foram_Dialog):
        ...
        self.content_tableWidget.setColumnCount(0)  #set numof column
        self.content_tableWidget.setRowCount(0)     #set num of row 
        ...
        #self.mat_type_listWidget.itemClicked.connect(lambda: self.get_item())
